...
def get_distance(landmark_list):
    ...
    return np.linalg.norm([x2 - x1, y2 - y1])  # No need for interpolation
...
def find_finger_tip(processed):
    ...
    if processed.multi_hand_landmarks:
        ...
        return (index_finger_tip.x, index_finger_tip.y)  # Return as tuple
    return None
...
def move_mouse(index_finger_tip):
    ...
    if index_finger_tip:
        ...
        y = int(index_finger_tip[1] / 2 * screen_height)
...
def detect_gesture(frame, landmark_list, processed):
    """Detects gestures and performs actions accordingly."""
...
def main():
    """Main function to run gesture-based mouse control."""
